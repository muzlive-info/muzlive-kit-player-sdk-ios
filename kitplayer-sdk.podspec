Pod::Spec.new do |spec|
  ...
  spec.source       = { :http => "https://github.com/muzlive-info/muzlive-kit-player-sdk-ios/releases/download/v1.0.54/kitplayer-sdk.zip", :sha1 => "c6e3087b6e4eadaf77d0d6956638272484fc2077" }
