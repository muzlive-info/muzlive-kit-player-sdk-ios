Pod::Spec.new do |spec|
  ...
  spec.source       = { :http => "https://github.com/muzlive-info/muzlive-kit-player-sdk-ios/releases/download/v1.0.34/kitplayer-sdk.zip", :sha1 => "632963621114524f0fda6b8402580de02c48d28c" }
