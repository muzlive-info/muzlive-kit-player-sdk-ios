Pod::Spec.new do |spec|
  ...
  spec.source       = { :http => "https://github.com/muzlive-info/muzlive-kit-player-sdk-ios/releases/download/v1.0.49/kitplayer-sdk.zip", :sha1 => "452586d5f37d85a4ed7c3ab0de3e6d69712eaa4c" }
