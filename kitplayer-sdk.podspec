Pod::Spec.new do |spec|
  ...
  spec.source       = { :http => "https://github.com/muzlive-info/muzlive-kit-player-sdk-ios/releases/download/v1.0.55/kitplayer-sdk.zip", :sha1 => "90d680c8fc346cd38a9d5011c61711092e924f7a" }
