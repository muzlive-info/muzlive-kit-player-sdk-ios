Pod::Spec.new do |spec|
  ...
  spec.source       = { :http => "https://github.com/muzlive-info/muzlive-kit-player-sdk-ios/releases/download/v1.0.47/kitplayer-sdk.zip", :sha1 => "2b2581bbe0c7ac5ab47de81eb154876f6eda4890" }
