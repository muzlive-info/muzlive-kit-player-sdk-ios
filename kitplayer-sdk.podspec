Pod::Spec.new do |spec|
  ...
  spec.source       = { :http => "https://github.com/muzlive-info/muzlive-kit-player-sdk-ios/releases/download/v1.0.46/kitplayer-sdk.zip", :sha1 => "96b60c719c23da6dbfd606ec25088f0423ed25ea" }
