...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "KiTPlayerSDK",
            url: "https://github.com/muzlive-info/muzlive-kit-player-sdk-ios/releases/download/v1.0.13/KiTPlayerSDK.xcframework.zip",
            checksum: "52450ef28186c59160a2a2b736957bece2f2d7a3ac1102637edbe546a85f3f33"
        ),
        .target(
